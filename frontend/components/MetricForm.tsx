        ...
        <div key={index} className="bg-gray-100 p-4 rounded-lg shadow-md mb-4">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <input
              ...
              onChange={(e) =>
                onChangeMetric(metric.id, "name", e.target.value)
              }
            ...
            <input
              ...
              disabled={metric.isDefault}
              onChange={(e) =>
                onChangeMetric(metric.id, "description", e.target.value)
              }
              className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-500"
            />
            <input
              ...
              disabled={metric.isDefault}
              onChange={(e) =>
                onChangeMetric(metric.id, "weight", parseFloat(e.target.value))
              }
              step="0.01"
              className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-500"
            />
